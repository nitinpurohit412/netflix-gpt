...
const Header = () => {
  ...
  return (
    <div className="absolute w-full px-8 py-6  z-10 flex flex-col md:flex-row justify-between">
      ...
      {user && (
        <div className="flex justify-between">
          ...
          <img className="hidden md:block w-10 rounded-md mr-2" src={PHOTOURL} alt="" />
